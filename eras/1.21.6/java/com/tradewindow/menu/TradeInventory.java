...
public final class TradeInventory {
	...
	public static ItemStack head(ServerPlayer owner, ChatFormatting colour) {
		...
		stack.set(DataComponents.PROFILE, new ResolvableProfile(owner.getGameProfile()));
	...
	public static ItemStack lockButton(boolean locked) {
		if (locked) {
			ItemStack spent = new ItemStack(Items.GREEN_STAINED_GLASS_PANE);
			spent.set(DataComponents.CUSTOM_NAME, Component
					.literal(TradeText.get("tradewindow.gui.locked"))
					.withStyle(ChatFormatting.GREEN));
			return spent;
		}
		return namedConcrete(Items.GREEN_CONCRETE, "tradewindow.gui.lock.name",
	...
	public static ItemStack cancelButton() {
		return namedConcrete(Items.RED_CONCRETE, "tradewindow.gui.cancel.name",
